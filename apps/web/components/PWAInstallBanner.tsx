            ...
            {isIOS ? (
              <>
                <div className="flex items-center gap-2">
                  <span className="shrink-0 w-5 h-5 rounded-full bg-sage text-white text-xs flex items-center justify-center font-medium">
                    1
                  </span>
                  <span>
                    点击底部工具栏的{" "}
                    <IOSShareIcon className="inline-block align-text-bottom mx-0.5" /> 分享按钮
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="shrink-0 w-5 h-5 rounded-full bg-sage text-white text-xs flex items-center justify-center font-medium">
              ...
              <>
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    点击地址栏右侧的 <strong>安装</strong> 图标（或浏览器菜单 ⋮）
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="shrink-0 w-5 h-5 rounded-full bg-sage text-white text-xs flex items-center justify-center font-medium">
