...
export const CALLBACK_PATH = process.env.NEXT_PUBLIC_AUTH_CALLBACK_PATH ?? DEFAULT_CALLBACK_PATH;
export const AUTH_ISSUER =
  process.env.AUTH_ISSUER ?? process.env.NEXT_PUBLIC_AUTH_ISSUER ?? DEFAULT_AUTH_ISSUER;
...
export const APP_ORIGIN =
  process.env.APP_ORIGIN ?? process.env.NEXT_PUBLIC_APP_ORIGIN ?? DEFAULT_APP_ORIGIN;
